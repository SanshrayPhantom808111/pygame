...
font_size = 72
pygame.init()
background_image = pygame.transform.scale(pygame.image.load("brawlhalla.jpg"),(screen_width, screen_height))
...
while running:
    ...
    if won:
        ...
        screen.blit(win_text,((screen_width-win_text.screen_width())//2,(screen_height - win_text.get_height())//2))
    pygame.display.flip()
    clock.tick(90)
pygame.quit()